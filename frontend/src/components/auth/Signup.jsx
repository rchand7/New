        ...
        <div>
            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto'>
                <form onSubmit={submitHandler} className='w-full sm:w-3/4 md:w-1/2 border border-gray-200 rounded-md p-4 my-10'>
                    <h1 className='font-bold text-2xl sm:text-xl mb-5 text-center'>Sign Up</h1>
                    <div className='my-2'>
                    ...
                    <span className='text-sm block text-center mt-4'>Already have an account? <Link to="/login" className='text-blue-600'>Login</Link></span>
                </form>
            </div>
        </div>
    );
